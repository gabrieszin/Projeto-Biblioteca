...
?>
  ...
  <main class="container mt-4">
    <p>Início -> Lista de Alunos -> Editar Aluno</p>
          ...
          <form action="../controller/alunos.php" method="POST">
            ...
            <section class="endereco">
              ...
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" id="rua" name="rua" placeholder="Ex Rua ABC, N.º 123" readonly <?php echo "value='$enderecoAluno'" ?>>
              </div>
              <div class="form-group mb-3">
